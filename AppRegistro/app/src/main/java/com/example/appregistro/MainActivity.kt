...
class MainActivity : AppCompatActivity() {
    //Declaracion de variables para vista
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Llenando el spinner de Departamentos
        ...
        //Funcion para el listado de Municipios para cada Departamento
        fun getMunicipios(depto:String):ArrayList<String>{
            val muni= arrayListOf<String>()
            when(depto){
                "Chalatenango"->muni.addAll(listOf("El Carrizal","San Francisco Morazán","Agua Caliente",
                    "Arcatao","Azacualpa","Chalatenango","Citalá","Nueva Concepción",
                    "Comalapa","Concepción Quezaltepeque","Dulce Nombre de María","El Paraíso",
                    "La Laguna","La Palma","La Reina","Las Vueltas","Nombre de Jesús","San Fernando",
                    "San Francisco Lempa","Ojos de Agua","San José Las Flores","Santa Rita",
                    "Nueva Trinidad","Potonico","San Antonio de la Cruz","San Antonio Los Ranchos",
                    "San Ignacio","San Isidro Labrador","San José Cancasque","San Luis del Carmen","Tejutla","San Miguel de Mercedes","San Rafael"))
